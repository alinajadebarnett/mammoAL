...
from nnUNet.nnunet.utilities.task_name_id_conversion import convert_id_to_task_name
from nnUNet.nnunet.preprocessing.sanity_checks import verify_dataset_integrity
...
class nnunet_model(seg_model.seg_model): 
    ...
    def load_new_data(self, train_dir):
        self.trainer.dataset_directory = train_dir
        self.trainer.initialize(True)
    ...
    def save_model(self, save_path):
        ...
        # Try adding model_folder_name parameter
    def predict(self, input_folder, output_folder = None, correct_save_dir = None, saved_oracle_filepaths = {}):
        ...
        # self.save_path = '/usr/xtmp/sc834/mammoproj/data/nnUNet_trained_models/nnUNet/2d/Task501_cbis-ddsm/nnUNetTrainerV2__nnUNetPlansv2.1'
